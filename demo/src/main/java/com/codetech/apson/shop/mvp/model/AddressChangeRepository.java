 ...
 */
public class AddressChangeRepository implements IModel {
    private IRepositoryManager mManager;

    public AddressChangeRepository(IRepositoryManager manager) {
        this.mManager = manager;
    }

    public Observable<BaseResponse<String>> postAddress(String userID,String userKEY,String addtype, String id, String name
            , String tel,String provice
            , String city, String county
            , String provinceCode, String cityCode, String countyCode
            , String moreAddr){
        return mManager.createRetrofitService(AddressService.class).postAddress(userID,userKEY,addtype,id,name,tel,provice,city,county,provinceCode,cityCode,countyCode,moreAddr);
