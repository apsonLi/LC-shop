 ...
 */
public class StartPageRepository implements IModel {
    private IRepositoryManager mManager;

    public StartPageRepository(IRepositoryManager manager) {
        this.mManager = manager;
    }


    public Observable<MyBaseResponse<MyUser>> getTest(String userID , String userKEY , String id){
        return mManager.createRetrofitService(CommonService.class).test(userID,userKEY,id);
    }
    @Override
