...
public class loginRepository implements IModel {
    ...
    public Observable<BaseResponse<ClientUser>> getClientUser(String userName, String userPassword){
        return  mManager.createRetrofitService(MyUserService.class).getClientUser(userName,userPassword);
    }
